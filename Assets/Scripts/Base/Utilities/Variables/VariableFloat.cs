...
public class VariableFloat : Variable
{
    ...
    [SerializeField] private float mimValue = 0;
    ...
    public void SetMimValue(float val)
    {
        mimValue = val;
    }
